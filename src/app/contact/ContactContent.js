      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <h3 className="font-medium mb-2">Vous déplacez-vous en dehors de Rennes ?</h3>
              <p className="text-gray-600">
                Absolument ! Je me déplace dans toute la Bretagne et la France pour capturer votre mariage. Des frais de déplacement peuvent s&apos;appliquer selon la destination.
              </p>
            </div>
        ...
        {/* Carte — chargée uniquement après consentement cookies */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
