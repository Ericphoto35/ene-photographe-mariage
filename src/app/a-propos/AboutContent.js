      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          ...
          >
            ...
            <div className="h-1 w-20 bg-gray-300"></div>
            <p className="text-gray-600">
            &ldquo;Notre aventure dans la photographie de mariage a commencé comme une exploration passionnée, un chemin que nous avons tracé nous-même, pas à pas.
            ...
            cherchant à immortaliser non seulement l&apos;événement, mais aussi les émotions profondes qui vous unissent.&rdquo;
            </p>
          </motion.div>
