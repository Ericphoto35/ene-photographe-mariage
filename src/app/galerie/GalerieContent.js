...
export default function GalerieContent() {
  ...
  const allImages = [
    ...
    },
    {
      ...
      location: 'Cancale',
      description: 'Une séance d\'engagement sur les côtes pittoresques de Cancale.',
      category: 'Couples'
    },
    {
      id: 9,
    ...
    <div className="min-h-screen pt-24 pb-20">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-16">
          ...
          >
            Découvrez une sélection de mes photographies de mariage, capturant l&apos;amour, l&apos;émotion et la beauté de ces journées spéciales en Bretagne et partout en France.
          </motion.p>
        </div>
